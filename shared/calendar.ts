...
export const calendarEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    "city": "全球",
    "venue": "点击“报名”，加入「长风论坛｜科技」社群后，发送会议链接",
    "organizer": "北雍文化商业智库",
    "summary": "从内战到皇家学会：商业都市、公共舆论与实验事实",
    "description": [
      "这周日早上，一起聊一个有意思的问题：科学为什么会变成今天这样的科学？",
      "北雍《科学的神话》英国篇第二章，我们从17世纪英国出发。",
      "从一封封书信，到皇家学会；",
      "从波义耳的空气泵实验，到霍布斯的质疑；",
      "从胡克的天气表格，到《哲学汇刊》；",
      "最后走到1666年伦敦大火后的城市重建。",
      "表面上讲的是科学史，真正想追问的却是：",
      "知识是怎样被相信、被保存、被比较，最后成为一群人可以长期协作的能力？"
    ],
    "highlights": [
      "小型线下讨论",
      "英法制度比较",
    ...
    "cover": "/assets/calendar/published/science-myth-uk-france-transition-poster.webp",
    "priceType": "free",
    "capacity": 20,
    "registrationStatus": "open",
